...
<head>
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg bg-secondary navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav ml-auto py-0">
                            ...
                            <a href="viewUser.jsp" class="nav-item nav-link active">User</a>
        ...
        <div class="container-fluid page-header d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5 mb-5">
            <h1 class="display-4 text-white mb-3 mt-0 mt-lg-5">All Users</h1>
        ...
        <div class="col-10 table-responsive admin-view-user-border">
            <h1 class="offset-3 pb-4">List of all registered users</h1>
            ...
            <!-- Table of Registered User Data End -->
