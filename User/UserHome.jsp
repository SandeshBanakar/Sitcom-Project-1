        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="img-fluid" src="../img/van-travel.jpg" alt="Van Travelling on a Mexican Road">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-md-3">Top Notch Travel Agency</h5>
                            <h1 class="display-3 text-white mb-md-4">Astonishing places for you to visit</h1>
                            <a href="userabout.html" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="img-fluid" src="../img/cruise-california.jpg" alt="A Cruise in California">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-md-3">Travel any way you want</h5>
                            <h1 class="display-3 text-white mb-md-4">There are great places to be discovered</h1>
                            <a href="userabout.html" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="img-fluid" src="../img/flight-on.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-md-3">Fligh High With Us</h5>
                            <h1 class="display-3 text-white mb-md-4">Happy travel and Happy day</h1>
                            <a href="userabout.html" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Learn More</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center pb-1">
                <div class="col-lg-5">
                    <img class="img-thumbnail p-3" src="../img/rower-amazon.jpg" alt="">
                </div>
                <div class="col-lg-7 mt-5 mt-lg-0">
                    <small class="bg-primary text-white text-uppercase font-weight-bold px-1">Who We Are</small>
                    <h1 class="mt-2 mb-4">Most Affordable Travel Booking Service</h1>
                    <p class="mb-4" style="color: black;">We offer you the best-in-class top quality service with 
                        an affordable price, so that you and your loved ones can enjoy the trip as much
                        as you can while we plan and organise your trip. </p>
                    <a href="userabout.html" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold">Read More</a>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="d-flex align-items-center border mb-4 mb-lg-0 p-4" style="height: 120px;">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">Metagalli, Mysore, Karnataka - 570016</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex align-items-center border mb-4 mb-lg-0 p-4" style="height: 120px;">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">isandeshbanakar@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-5">
                            <div class="d-flex flex-column align-items-center justify-content-center bg-primary p-4">
                                ...
                                <h1 class="display-4 mb-0">
                                    <small class="align-top"
                                        style="font-size: 22px; line-height: 45px;">Rs.</small>899<small
                            ...
                            <div class="border border-top-0 d-flex flex-column align-items-center py-4">
                                ...
                                <p>Free WiFi</p>
                                <a href="userticket.jsp" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold my-2">Book Now</a>
                            </div>
                        </div>
                        <div class="col-md-6 mb-5">
                            <div class="d-flex flex-column align-items-center justify-content-center bg-primary p-4">
                                ...
                                <h1 class="display-4 mb-0">
                                    <small class="align-top"
                                        style="font-size: 22px; line-height: 45px;">Rs.</small>1,099<small
                                        class="align-bottom" style="font-size: 16px; line-height: 40px;">/
                                        Night</small>
                                </h1>
                            </div>
                            <div class="border border-top-0 d-flex flex-column align-items-center py-4">
                                <p>Hygienic Rooms</p>
                                <p>Swimming Pool + Golf Club + Horse Riding</p>
                                <p>Multi-Cuisine Restaurant Access</p>
                                <p>4K TV + Free WiFi</p>
                                <a href="userticket.jsp" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold my-2">Book Now</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-5 mb-5">
                    ...
                    <h4 class="font-weight-normal text-muted mb-4">Come join us on our journey to make life more colorful by
                        traveling to places and embrace the beauty of God's creation.
                    </h4>
                    <h5 class="font-weight-bold mb-4">Need A Custom Package?</h5>
                    <a href="userabout.html" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold">Contact Now</a>
                </div>
            </div>
        </div>
    </div>
